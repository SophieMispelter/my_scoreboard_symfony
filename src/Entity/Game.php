...
class Game
{
    ...
    #[ORM\Column(type: 'string', length: 30, unique: true)]//la propriété unique rajoute un index unique ds la bdd sur la propriété, il ne pourra donc pas y avoir deux fois le même titre, ATTENTION pr toute modification de la bdd, faire un make:migration puis un doctrine:migration:migrate sur console
    private $title;
